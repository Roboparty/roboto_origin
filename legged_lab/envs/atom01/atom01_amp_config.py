...
class ATOM01RewardCfg(RewardCfg):
    ...
    feet_distance = RewTerm(
        ...
        weight=0.1,
        params={"asset_cfg": SceneEntityCfg("robot", body_names=[".*ankle_roll.*"]), "min": 0.17, "max": 0.50},
    )
...
class ATOM01AmpAgentCfg(BaseAgentCfg):
    def __post_init__(self):
        ...
        self.amp_motion_files = ["legged_lab/envs/tienkung/datasets/motion_amp_expert/run.txt"]
