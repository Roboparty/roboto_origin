...
ROUGH_TERRAINS_CFG = TerrainGeneratorCfg(
    ...
    sub_terrains={
        ...
        "slope": terrain_gen.HfPyramidSlopedTerrainCfg(
            proportion=0.1, slope_range=(0.0, 0.3), border_width=1.0, platform_width=2.0
        ),
        "inv_slope": terrain_gen.HfInvertedPyramidSlopedTerrainCfg(
            proportion=0.1, slope_range=(0.0, 0.3), border_width=1.0, platform_width=2.0, inverted=True
        ),
...
ROUGH_HARD_TERRAINS_CFG = TerrainGeneratorCfg(
    ...
    sub_terrains={
        ...
        "slope": terrain_gen.HfPyramidSlopedTerrainCfg(
            proportion=0.05, slope_range=(0.0, 0.3), border_width=1.0, platform_width=2.0
        ),
        "inv_slope": terrain_gen.HfInvertedPyramidSlopedTerrainCfg(
            proportion=0.05, slope_range=(0.0, 0.3), border_width=1.0, platform_width=2.0, inverted=True
        ),
        "grid": terrain_gen.MeshRandomGridTerrainCfg(
            proportion=0.1, grid_width=0.45, grid_height_range=(0.0, 0.2), platform_width=2.0
        ),
        "random_rough": terrain_gen.HfRandomUniformTerrainCfg(
            proportion=0.1, noise_range=(-0.02, 0.04), noise_step=0.02, border_width=1.0
        ),
        "high_platform": terrain_gen.MeshPitTerrainCfg(
            proportion=0.1, pit_depth_range=(0.0, 0.35), platform_width=2.0, double_pit=True
        ),
        "star": terrain_gen.MeshStarTerrainCfg(
            proportion=0.1, num_bars=12, bar_width_range=(0.3, 0.5), bar_height_range=(10.0, 10.0), platform_width=2.0
        ),
